...
function Header() {
  return (
    <>
      ...
      <header className="container mx-auto px-4 bg-teal-500 flex flex-col justify-between items-left py-1">
        <div className="flex items-center mb-2 gap-5">
          <div className='flex items-center gap-3'>
            <img src="https://i.imgur.com/Tei2Tve.png" alt="logo" className="w-30 h-12" />
            <h1 className="text-white text-2xl font-bold flex flex-col">Your Space</h1>
          </div>
          <form className="flex items-center gap-2">
            <label htmlFor="search" className="text-white text-xs">Search Users:</label>
            <input
              type="search"
              id="search"
              ...
              />
            <button type="submit" className="px-4 py-1 rounded bg-white text-blue-500 hover:bg-blue-500 hover:text-white font-small transition duration-300 ease-in-out">Search</button>
          </form>
   <button type="button" className="px-4 py-1 rounded bg-teal-500 text-white hover:bg-white hover:text-teal-500 font-xs transition duration-300 ease-in-out">Logout</button> 
      </div>
